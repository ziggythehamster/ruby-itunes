...
# As far as iTunes is concerned, there is only one
# iTunesApp, but we allow creating more than one.
# You never know, maybe it'll matter.
class ITunesApp

	# Called when you call ITunesApp.new
	def initialize
